...
(function(window) {
    ...
    Aero.GLUploaders = {
        ...
        uniform1iv: function(gl, u_loc, u_val){
            gl.uniform2iv.apply(gl, [u_loc].concat( u_val ));
        },        
